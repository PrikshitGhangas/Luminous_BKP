...
### Phase 0: Foundation (Hours 0–3) [TIME]
...
### Phase 1: Auth + Layout (Hours 3–6) [TIME]
> Can partially parallelize

| # | Task | Est. | Dependencies | Owner | Parallel? |
|---|------|------|-------------|-------|-----------|
| 1.1 | Login page UI | 45m | 0.7 | Frontend A | [PASS] with 1.3 |
| 1.2 | Register page UI | 30m | 1.1 | Frontend A | |
| 1.3 | Auth API (login, register, logout hooks) | 45m | 0.5, 0.8 | Backend | [PASS] with 1.1 |
| 1.4 | Profile creation trigger (DB function) | 20m | 0.6 | Backend | |
| 1.5 | Dashboard layout (sidebar + topbar) | 60m | 0.7 | Frontend B | [PASS] with 1.1, 1.3 |
...
### Phase 2:  HERO — AI Incident System (Hours 6–14) [TIME]
> This is the CORE. Spend the most time here.

| # | Task | Est. | Dependencies | Owner | Parallel? |
|---|------|------|-------------|-------|-----------|
| 2.1 | Gemini client setup + system prompts | 45m | 0.4 | AI Dev | [PASS] with 2.3 |
| 2.2 | AI output Zod schemas | 30m | 2.1 | AI Dev | |
| 2.3 | Incident report form UI (multi-step) | 90m | 1.5 | Frontend A | [PASS] with 2.1 |
...
| 2.7 | `/api/incidents` GET route (list, filtered) | 30m | 0.6 | Backend | [PASS] with 2.6 |
| 2.8 | Incident list page UI | 45m | 2.7 | Frontend B | |
| 2.9 | Incident detail page + timeline UI | 60m | 2.7 | Frontend B | [PASS] with 2.6 |
| 2.10 | Incident status update API + UI | 45m | 2.6 | Backend | |
| 2.11 | Supabase Realtime subscriptions (incidents) | 45m | 2.6 | Backend | [PASS] with 2.8 |
...
### Phase 4: Safety Features (Hours 20–26) [TIME]
> Deepen the safety story

| # | Task | Est. | Dependencies | Owner | Parallel? |
|---|------|------|-------------|-------|-----------|
| 4.1 | SOS panic button UI | 45m | 1.5 | Frontend A | [PASS] with 4.4 |
| 4.2 | SOS API (trigger + respond + resolve) | 45m | 0.6 | Backend | [PASS] with 4.1 |
| 4.3 | SOS realtime on command center | 30m | 4.2, 3.10 | Backend | |
| 4.4 | Safety Analytics page layout | 45m | 1.5 | Frontend B | [PASS] with 4.1 |
| 4.5 | `/api/ai/safety-insights` route | 60m | 2.1 | AI Dev | [PASS] with 4.4 |
...
| 4.10 | Visitor management CRUD UI | 45m | 1.5 | Frontend A | [PASS] with 4.5 |
| 4.11 | Visitor management API | 30m | 0.6 | Backend | [PASS] with 4.10 |
| 4.12 | Security operations dashboard | 45m | 3.1 | Frontend A | |
| 4.13 | Audit logs page + API | 45m | 0.6 | Backend | [PASS] with 4.12 |

**Gate**: SOS works, analytics show charts + AI insights, visitors tracked, audit logs visible.

---

### Phase 5: ERP Features (Hours 26–34) [TIME]
> Build quickly — these are secondary to safety

| # | Task | Est. | Dependencies | Owner | Parallel? |
|---|------|------|-------------|-------|-----------|
| 5.1 | Shared DataTable component | 45m | 1.5 | Frontend A | |
| 5.2 | Students page (list + basic CRUD) | 45m | 5.1 | Frontend A | [PASS] with 5.3 |
| 5.3 | Faculty page (list + basic CRUD) | 45m | 5.1 | Frontend B | [PASS] with 5.2 |
| 5.4 | Students/Faculty API routes | 45m | 0.6 | Backend | [PASS] with 5.2 |
| 5.5 | Attendance page (mark + view) | 60m | 5.4 | Frontend A | |
| 5.6 | Attendance API | 30m | 0.6 | Backend | [PASS] with 5.5 |
| 5.7 | Timetable page (grid view) | 45m | 1.5 | Frontend B | [PASS] with 5.5 |
| 5.8 | Exams page (schedule + results) | 45m | 5.1 | Frontend A | [PASS] with 5.7 |
| 5.9 | Hostel page | 30m | 5.1 | Frontend B | [PASS] with 5.8 |
| 5.10 | Transport page | 30m | 5.1 | Frontend A | [PASS] with 5.9 |
| 5.11 | Complaints page + API | 45m | 5.1 | Frontend B | [PASS] with 5.10 |
| 5.12 | Placements page | 30m | 5.1 | Frontend A | [PASS] with 5.11 |
| 5.13 | Communication/Announcements page | 30m | 5.1 | Frontend B | [PASS] with 5.12 |
| 5.14 | Parent portal (read-only views) | 30m | 5.4 | Frontend A | |
| 5.15 | ERP API routes (batch) | 60m | 0.6 | Backend | [PASS] with 5.2 |

**Gate**: All ERP pages show data, basic CRUD works, parent can view child data.

---

### Phase 6: Polish + Demo Prep (Hours 34–38) [TIME]
> Make it shine

| # | Task | Est. | Dependencies | Owner | Parallel? |
|---|------|------|-------------|-------|-----------|
| 6.1 | Role-based dashboard landing pages | 60m | All phases | Frontend A | [PASS] with 6.2 |
| 6.2 | Mobile responsive check + fixes | 45m | All phases | Frontend B | [PASS] with 6.1 |
| 6.3 | Loading states + skeletons | 30m | All phases | Frontend A | |
| 6.4 | Error handling + toast notifications | 30m | All phases | Frontend B | |
| 6.5 | Refresh demo seed data | 30m | All phases | Backend | [PASS] with 6.1 |
