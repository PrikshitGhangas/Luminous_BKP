    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5">
        <Card className="bg-[#0F1026] border-[#243356] text-[#F4F1DE]">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-[11px] font-mono text-[#C5A059] uppercase tracking-wider">Total Instructors</p>
        ...
        <Card className="bg-[#0F1026] border-[#243356] text-[#F4F1DE]">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-[11px] font-mono text-[#C5A059] uppercase tracking-wider">Professors &amp; HODs</p>
        ...
        <Card className="bg-[#0F1026] border-[#243356] text-[#F4F1DE]">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-[11px] font-mono text-[#C5A059] uppercase tracking-wider">Research Papers</p>
              <h3 className="text-xl font-bold font-mono mt-0.5 text-[#FFD700]">{totalPublications}</h3>
            </div>
        ...
        <Card className="bg-[#0F1026] border-[#243356] text-[#F4F1DE]">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              <p className="text-[11px] font-mono text-[#C5A059] uppercase tracking-wider">Avg Student Rating</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredFaculty.map((f) => (
          ...
          >
            <CardHeader className="p-4 pb-3 border-b border-[#243356] bg-[#131C38]/40 flex flex-row items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <h3 className="text-sm font-bold text-[#F4F1DE] font-mono">{f.name}</h3>
                  <div className="flex items-center gap-1.5 mt-0.5">
                    <Badge className="bg-purple-500/15 text-purple-300 border-purple-500/30 text-[9px] font-mono">
                      {f.designation}
                    </Badge>
                    <span className="text-[10px] text-[#B8B5A3] font-mono">{f.employeeId}</span>
                  </div>
                </div>
              </div>
            ...
            <CardContent className="p-4 space-y-3 text-xs flex-1">
              <p className="text-[#C5A059] font-mono text-[11px] font-semibold">{f.department}</p>

              <div className="space-y-1 text-[#B8B5A3] text-[11px]">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-[#243356] font-mono text-[10px]">
                <div className="bg-[#1C2541]/50 p-2 rounded border border-[#243356]">
                  <span className="text-[#B8B5A3] block text-[9px]">PUBLICATIONS</span>
                  <span className="font-bold text-[#FFD700] text-xs">{f.publicationsCount} Papers</span>
                </div>
                <div className="bg-[#1C2541]/50 p-2 rounded border border-[#243356]">
                  <span className="text-[#B8B5A3] block text-[9px]">RATING</span>
            ...
            <CardContent className="p-4 space-y-3.5">
              <form onSubmit={handleCreateFaculty} className="space-y-3 text-xs">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="text-[10px] font-mono text-[#C5A059] uppercase block mb-1">Employee ID *</label>
                    <Input
                      required
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="text-[10px] font-mono text-[#C5A059] uppercase block mb-1">Designation</label>
                    <select
                ...
                <div>
                  <label className="text-[10px] font-mono text-[#C5A059] uppercase block mb-1">Specialization &amp; Research</label>
                  <Input
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-[10px] font-mono text-[#C5A059] uppercase block mb-1">Office Room</label>
                    <Input
                      value={newOffice}
                  ...
                  <div>
                    <label className="text-[10px] font-mono text-[#C5A059] uppercase block mb-1">Phone Number</label>
                    <Input
                      value={newPhone}
          ...
          <Card className="w-full max-w-lg bg-[#0F1026] border-[#243356] text-[#F4F1DE]">
            ...
            <CardContent className="p-4 space-y-4 text-xs">
              <div className="bg-[#131C38] p-3 rounded-lg border border-[#243356] space-y-1">
                <span className="text-[10px] text-[#C5A059] font-mono uppercase block">Department &amp; Research</span>
                <p className="font-bold text-[#F4F1DE]">{selectedFaculty.department}</p>
                <p className="text-[#B8B5A3] text-[11px]">Field: {selectedFaculty.specialization}</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-[11px]">
                ...
                <div className="flex items-center gap-2 text-[#FFD700] font-bold font-mono">
              ...
              <div>
                <h4 className="font-mono text-[10px] text-[#C5A059] uppercase font-bold mb-1.5">
