...
export default function RiskIntelligencePage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[40vh] text-center p-6 space-y-3">
      ...
      <h2 className="text-base font-bold text-[#1F2933]">Risk Event Logs</h2>
      <p className="text-xs text-[#667085] max-w-sm">
        Risk intelligence records and safety event logs have been unified into the System &amp; Safety Logs page.
      </p>
